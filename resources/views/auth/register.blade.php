...
<div class="min-h-screen bg-gray-100 flex flex-col md:-pt-4 py-6 px-6 lg:px-8" id="particles-js">
    ...
    <div class="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
      <form class="mb-0 space-y-6" method="POST">
        ...
        <div>
          ...
          <div class="mt-1">
            <input id="nama" name="nama" type="text" required class="border h-8 w-full p-2" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input id="nomor_telepon" name="nomor_telepon" type="number" required class="border h-8 w-full p-2" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <textarea class="border w-full p-2" name="alamat" id="alamat" rows="2" placeholder="Opsional"></textarea>
          </div>
        </div>
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-md sm:--mt-4 z-10">
    <p class="mt-2 text-center text-sm text-gray-600 max-w">
      Sudah punya akun?
      <a href="/login" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">Login</a>
    </p>
  </div>
</div>
