      ...
      <form class="mb-0 space-y-6" method="POST">
        ...
        <div>
          ...
          @if($k['status'] != 'nonaktif')
            @if($k['id'] == $rental[0]['id_konsol'])
            <option value="{{$k['id']}}" selected>{{$k['id']}}</option>
            @else
        ...
        <div>
          ...
          <div class="mt-1">
            <input type="datetime-local" class="input input-bordered w-full" id="mulai" name="mulai" value="{{$rental[0]['mulai']}}" required>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input type="datetime-local" min="{{$rental[0]['mulai']}}" class="input input-bordered w-full" id="selesai" name="selesai" value="{{$rental[0]['selesai']}}" required>
          </div>
        </div>
