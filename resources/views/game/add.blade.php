...
<div class="min-h-screen bg-gray-100 flex flex-col md:-pt-4 py-6 px-6 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-md sm:--mt-4">
    <h2 class="text-center text-3xl font-extrabold text-gray-900">Tambah Game</h2>
  </div>
    ...
    <div class="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
      <form class="mb-0 space-y-6" method="POST" enctype="multipart/form-data">
        ...
        <div>
          ...
          <div class="mt-1">
            <input type="text" id="judul" name="judul" class="input input-bordered w-full" required/>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input type="text" id="genre" name="genre" class="input input-bordered w-full" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input type="text" id="link" name="link" class="input input-bordered w-full" />
          </div>
        </div>

        <div>
          <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Tambah</button>
        </div>
      </form>
    </div>
  </div>
